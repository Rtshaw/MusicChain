...
class UserProfile(AbstractUser):
    ...
    gender = models.CharField(max_length=6, choices=(('male', '男'), ('female', '女')), default='female',
                              verbose_name=u'性別')
    prvateKey = models.CharField(max_length=150, null=True, blank=True, verbose_name=u'私鑰',unique=True)
    publicKey = models.CharField(max_length=150, null=True, blank=True, verbose_name=u'公鑰',unique=True)
